...
import autosaveworld.zlibs.com.dropbox.core.v2.async.PollEmptyResult;
    ...
    public List<GroupsGetInfoItem> groupsGetInfo(GroupsSelector arg) throws GroupsGetInfoErrorException, DbxException {
        try {
            return this.client.rpcStyle(this.client.getHost().getApi(),
                                        ...
                                        autosaveworld.zlibs.com.dropbox.core.stone.StoneSerializers.list(GroupsGetInfoItem.Serializer.INSTANCE),
    ...
    List<MembersGetInfoItem> membersGetInfo(MembersGetInfoArgs arg) throws MembersGetInfoErrorException, DbxException {
        try {
            return this.client.rpcStyle(this.client.getHost().getApi(),
                                        ...
                                        autosaveworld.zlibs.com.dropbox.core.stone.StoneSerializers.list(MembersGetInfoItem.Serializer.INSTANCE),
