...
public abstract class JsonReader<T> {
	...
	public static final class FieldMapping {
		...
		// - Don't use "HashMap". Do something gperf-like that generates a
		// faster hash
		// function for when you know the valid strings ahead-of-time.
		// - The get() could take (char[], offset, length) instead of String,
		// which we can
		// provide straight from JsonParser's internal buffer. This makes error
		// reporting
