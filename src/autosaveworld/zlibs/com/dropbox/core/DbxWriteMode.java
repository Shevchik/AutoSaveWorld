...
/**
 * Describes how a file should be saved when it is written to Dropbox. Do not call the constructor. Instead, call one of the three static functions: {@link #add}, {@link #force}, {@link #update}.
 */
public final class DbxWriteMode {
	...
	/**
	 * Returns a {@link DbxWriteMode} for adding new file. If a file at the specified path already exists, the new file will be renamed automatically.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * You can determine whether your file was renamed by checking the {@link DbxEntry#name} returned by the API call.
	 * </p>
	 */
