...
/**
 * A grouping of a few configuration parameters for how we should make requests
...
public class DbxRequestConfig {
	 ...
	 * should append your library's name and version to form the full
	 * identifier. For example, if your library is called "File Picker", you
	 ...
	 * the name of the library being used to actually make the HTTP request, or
	...
	/**
	 * The {@link HttpRequestor} implementation to use when making HTTP requests
	 * to the Dropbox API servers. If you don't specify one, this defaults to
