...
public class DbxRequestConfig {
	 ...
	 *
	 * <p>
	 * The exact format of the {@code User-Agent} header is described in <a href="http://tools.ietf.org/html/rfc2616#section-3.8">section 3.8 of the HTTP specification</a>.
	 * </p>
	 *
	 * <p>
	...
	/**
	 * The {@link HttpRequestor} implementation to use when making HTTP requests to the Dropbox API servers. If you don't specify one, this defaults to {@link StandardHttpRequestor#Instance}.
	 */
