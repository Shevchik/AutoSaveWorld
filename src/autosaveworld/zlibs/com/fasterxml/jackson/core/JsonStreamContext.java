 ...
 * writing of Json content using Streaming API. This context is also exposed to
 * applications: context object can be used by applications to get an idea of
 * relative position of the parser/generator within json content being
 * processed. This allows for some contextual processing: for example, output
 * within Array context can differ from that of Object context.
 */
public abstract class JsonStreamContext {
	 ...
	 * started, either by encountering an expected separator, or with new values
	...
	/**
	 * Method that returns true if this context is a Root context; that is,
	 * content is being read from or written to without enclosing array or
	 * object structure.
	 */
	...
	/**
	 * Method for accessing simple type description of current context; either
	 * ROOT (for root-level values), OBJECT (for field names and values of JSON
	 * Objects) or ARRAY (for values of JSON Arrays)
	 */
	...
	/**
	 * Method for accessing name associated with the current location. Non-null
	 * for <code>FIELD_NAME</code> and value events that directly follow field
