...
public class DataFormatDetector {
	...
	/**
	 * Method to call to find format that content (accessible via given {@link InputStream}) given has, as per configuration of this detector instance.
	 *
	 * @return Matcher object which contains result; never null, even in cases where no match (with specified minimal match strength) is found.
	 */
