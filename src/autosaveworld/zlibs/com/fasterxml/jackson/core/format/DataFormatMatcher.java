...
/**
 * Result object constructed by {@link DataFormatDetector} when requested to detect format of given input data.
 */
public class DataFormatMatcher {
	...
	/**
	 * Method for accessing strength of the match, if any; if no match, will return {@link MatchStrength#INCONCLUSIVE}.
	 */
	...
	/**
	 * Convenience method for trying to construct a {@link JsonParser} for parsing content which is assumed to be in detected data format. If no match was found, returns null.
	 */
