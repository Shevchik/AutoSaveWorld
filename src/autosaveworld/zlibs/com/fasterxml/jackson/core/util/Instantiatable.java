 ...
 * (serialization, deserialization) instances, using {@link #createInstance}
 * method.
 * <p>
 * Note that some implementations may choose to implement
 * {@link #createInstance} by simply returning 'this': this is acceptable if
...
public interface Instantiatable<T> {
	/**
	 * Method called to ensure that we have a non-blueprint object to use; it is
	 * either this object (if stateless), or a newly created object with
	 * separate state.
	 */
	T createInstance();
}
