...
public enum JsonEncoding {
	...
	UTF16_BE("UTF-16BE", true, 16), UTF16_LE("UTF-16LE", false, 16), UTF32_BE("UTF-32BE", true, 32), UTF32_LE("UTF-32LE", false, 32);
	...
	/**
	 * Whether encoding is big-endian (if encoding supports such notion). If no such distinction is made (as is the case for {@link #UTF8}), return value is undefined.
	 *
