...
public interface TreeNode {
	...
	/**
	 * If this node is a numeric type (as per {@link JsonToken#isNumeric}), returns native type that node uses to store the numeric value; otherwise returns null.
	 *
	 ...
	 *
	 * @return For non-container nodes returns 0; for arrays number of contained elements, and for objects number of fields.
	 *
	 * @since 2.2
	 */
	int size();
	...
	/**
	 * Method that returns true if this node is an Array node, false otherwise. Note that if true is returned, {@link #isContainerNode} must also return true.
	 *
	 * @since 2.2
	 */
	boolean isArray();
	...
	/**
	 * Method that returns true if this node is an Object node, false otherwise. Note that if true is returned, {@link #isContainerNode} must also return true.
	 *
	 * @since 2.2
	 */
	boolean isObject();
	 ...
	 *
	 * @return Node that represent value of the specified field, if this node is an object and has value for the specified field. Null otherwise.
	 *
	 * @since 2.2
	 */
	...
	/**
	 * Method for accessing value of the specified field of an object node. For other nodes, a "missing node" (virtual node for which {@link #isMissingNode} returns true) is returned.
	 *
	 * @return Node that represent value of the specified field, if this node is an object and has value for the specified field; otherwise "missing node" is returned.
	 *
	 * @since 2.2
	 */
	...
	/**
	 * Method for accessing names of all fields for this node, iff this node is an Object node. Number of field names accessible will be {@link #size}.
	 *
	 * @since 2.2
	 */
	 ...
	 * </pre>
	 * <p>
	 * Note that if the same expression is used often, it is preferable to construct {@link JsonPointer} instance once and reuse it: this method will not perform any caching of compiled expressions.
	 *
