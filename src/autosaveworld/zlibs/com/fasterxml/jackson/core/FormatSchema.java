...
/**
 * Simple tag interface used to mark schema objects that are used by some {@link JsonParser} and {@link JsonGenerator} implementations to further specify structure of expected format. Basic JSON-based parsers and generators do not use schemas, but some data formats (like many binary data formats like Thrift, protobuf) mandate use of schemas.
 * <p>
