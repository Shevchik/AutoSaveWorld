 ...
 * use a filter abstraction (filtered stream, reader) around original input
 * source, and apply additional processing during read operations.
 */
																		...
																		// 2.1
{
	 ...
	 *            initialized; specifically auto-detected encoding is only
	 *            available once parsing starts, which may occur only after this
	 *            method is called.
	 * @param in
	 ...
	 */
	public abstract InputStream decorate(IOContext ctxt, byte[] src,
	 ...
	 */
	public abstract Reader decorate(IOContext ctxt, Reader r)
			throws IOException;
}
