...
{
	/**
	 * Method called by {@link autosaveworld.zlibs.com.fasterxml.jackson.core.JsonFactory} instance when creating generator for given {@link OutputStream}, when this decorator has been registered.
	 *
	 * @param ctxt
	...
	/**
	 * Method called by {@link autosaveworld.zlibs.com.fasterxml.jackson.core.JsonFactory} instance when creating generator for given {@link Writer}, when this decorator has been registered.
	 *
	 * @param ctxt
	 *            IO context in use (provides access to declared encoding)
	 * @param w
